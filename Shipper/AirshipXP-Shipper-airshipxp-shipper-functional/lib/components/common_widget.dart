...
class ButtonPrimary extends StatelessWidget {
  ButtonPrimary({super.key, required this.onPressed, required this.title, this.style, this.height, this.borderRadius});
    ...
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: borderRadius ?? BorderRadius.circular(10), // <-- Radius
        ),
      ),
      onPressed: onPressed,
      child: Text(
    ...
    return RichText(
      ...
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
            style: kText14w400.copyWith(fontWeight: FontWeight.w500, color: linkTxtcolor),
            text: 'termsText2'.tr,
...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  CustomAppBar(
      {super.key, this.titleText, this.leading, this.action, this.style, this.leadingIconColor, this.bottom, this.flex, this.appBarColor, this.toolbarHeight});
  bool? leading;
  String? titleText;
  List<Widget>? action;
  TextStyle? style;
    ...
    return SafeArea(
      child: AppBar(
        ...
        title: flex == true
            ...
            : Text(
                '$titleText',
                style: style ?? kText24w600.copyWith(color: black, fontWeight: FontWeight.w700),
              ),
    ...
    return TextFormField(
      ...
      decoration: inputDecoration ??
          kTextInputDecoration.copyWith(
            isCollapsed: true,
            border: OutlineInputBorder(borderSide: BorderSide.none, borderRadius: radius ?? BorderRadius.circular(10)),
            // contentPadding:
            ...
            hintStyle: hintTextStyle ?? kText18w400.copyWith(color: inActiveGreyText, fontWeight: FontWeight.w300),
...
class ShadowContainer extends StatelessWidget {
  ShadowContainer({super.key, required this.child, this.padding, this.height, this.width, this.radius, this.shadow, this.color, this.alignment});
...
class TextButtonPrimary extends StatelessWidget {
  TextButtonPrimary({super.key, required this.onPressed, required this.label, this.color});
  VoidCallback onPressed;
  String label;
  Color? color;
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      child: Text(
        label,
        style: kText16w600.copyWith(color: color ?? black, overflow: TextOverflow.ellipsis),
      ),
    );
  }
}
          ...
          child: Container(
            ...
            decoration: decoration ??
                BoxDecoration(
                  ...
                  boxShadow: shadow == true ? [const BoxShadow(color: greyOp2, blurRadius: 5, blurStyle: BlurStyle.outer)] : [],
