...
class DrivingLicenseFrontImage extends StatelessWidget {
  DrivingLicenseFrontImage({super.key});
  ...
  void _showDatePicker(BuildContext context, BuildContext blocBuilderCtx) {
    showDatePicker(
      ...
      BlocProvider.of<UpdateCarrierLicenseBloc>(blocBuilderCtx).add(
          SelectDataEvent(
              licExpDate: licenseExpiryDateInputController.text, file: file));
    });
  }
  ...
  final UpdateCarrierLicenseBloc _updateCarrierLicenseBloc =
      UpdateCarrierLicenseBloc();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        flex: true,
        titleText: "Take a photo of your driving license",
          ...
          children: [
            ...
            ButtonPrimary(
              onPressed: () {
                ...
                //         '' &&
                //     profileController
                //             .drivingLicenseNumberInputController
                //             .text !=
                //         "") {
                //   profileController.drivingLicense.value = true;
                //   Get.back();
                //   profileController.temporaryImage.value ='';
                //   // profileController.setLicenseDetails();
                // }
                BlocProvider.of<UpdateCarrierLicenseBloc>(blocBuilderCtx).add(
                    UpdateCarrierLicenseSubmitEvent(
                        licExpDate: licenseExpiryDateInputController.text,
                        file: file,
                        licNo: drivingLicenseNumberInputController.text));
              },
              title: 'Submit'.tr,
            ),
          ],
